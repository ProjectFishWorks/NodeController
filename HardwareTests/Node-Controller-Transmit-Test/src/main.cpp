...
static const twai_general_config_t g_config = TWAI_GENERAL_CONFIG_DEFAULT((gpio_num_t)TX_GPIO_NUM, (gpio_num_t)RX_GPIO_NUM, TWAI_MODE_NORMAL);

twai_message_t ping_message;

twai_message_t start_message;

twai_message_t stop_message;
...
static void twai_transmit_task(void *arg)
{
  while (1)
  {
    ...
    else if (action == TX_SEND_START_CMD)
    {
      ...
      Serial.println("Transmitted start command");
    }
    else if (action == TX_SEND_STOP_CMD)
    {
      ...
      Serial.println("Transmitted stop command");
    }
...
{
Serial.begin(115200);
  ping_message.identifier = ID_MASTER_PING;
  ping_message.data_length_code = 0;
  ping_message.data[0] = 0;
  ping_message.extd = 0;
  ping_message.rtr = 0;
  ping_message.ss = 0;
  ping_message.self = 0;
  ping_message.dlc_non_comp = 0;

  start_message.identifier = ID_MASTER_START_CMD;
  start_message.data_length_code = 0;
  start_message.data[0] = 0;
  start_message.extd = 0;
  start_message.rtr = 0;
  start_message.ss = 0;
  start_message.self = 0;
  start_message.dlc_non_comp = 0;

  stop_message.identifier = ID_MASTER_STOP_CMD;
  stop_message.data_length_code = 0;
  stop_message.data[0] = 0;
  stop_message.extd = 0;
  stop_message.rtr = 0;
  stop_message.ss = 0;
  stop_message.self = 0;
  stop_message.dlc_non_comp = 0;
